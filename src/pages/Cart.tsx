      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {cartItems.length === 0 ? (
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-black text-brand-secondary mb-4">سلتك فارغة حالياً 🎈</h2>
            <p className="text-xl text-brand-muted font-bold mb-10">يبدو أنك لم تضف أي ألعاب ممتعة بعد!</p>
